...
void my_touchpad_read(lv_indev_drv_t *indev_driver, lv_indev_data_t *data)
{
  ...
  if (touch_st77922.Get_Touch())
  {
    ...
    if (x >= 0 && x < tft_st77922.Get_Width() && y >= 0 && y < tft_st77922.Get_Height())
    {
...
void Display::init(void)
{
  ...
  lv_init();
  lv_disp_draw_buf_init(&draw_buf, buf, NULL, tft_st77922.Get_Width() * 40);
  touch_st77922.init();
...
#ifdef FNK0104N_3P5_320x480_ST77922
  disp_drv.hor_res = tft_st77922.Get_Width();
  disp_drv.ver_res = tft_st77922.Get_Height();
#else
